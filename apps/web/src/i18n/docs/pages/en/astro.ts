...
export const astroENDoc: DocPageData = {
    ...
    sections: [
      ...
      { id: "package-links", label: "Package links", blocks: [{ type: "list", items: ['<a href="https://www.npmjs.com/package/@cmd-kit/astro" target="_blank" rel="noopener noreferrer"><span aria-hidden="true" style="display:inline-flex;width:14px;height:14px;vertical-align:-2px;margin-right:6px;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 3l8 4.5l0 9l-8 4.5l-8 -4.5l0 -9l8 -4.5"/><path d="M12 12l8 -4.5"/><path d="M12 12l0 9"/><path d="M12 12l-8 -4.5"/><path d="M16 5.25l-8 4.5"/></svg></span>NPM: @cmd-kit/astro</a>'] }] },
...
<CommandPalette sections={sections} title="Project commands" />` }] },
      ...
      { id: "customization", label: "Customization", blocks: [{ type: "paragraph", html: "The customization surface is the same one you already use in other adapters: <code>sections</code>, <code>messages</code>, <code>theme</code> (single or dual mode), <code>recents</code>, <code>reducedMotion</code>, and <code>size</code> (<code>&quot;small&quot; | &quot;normal&quot; | &quot;large&quot;</code>)." }, { type: "code", lang: "astro", label: "astro", code: `---
import CommandPalette from "@cmd-kit/astro/component";
...
/>` }] },
      { id: "add-a-new-command", label: "Add a new command", blocks: [{ type: "paragraph", html: "Add a new option by creating a new item in your section list. <code>shortcut</code> is optional." }, { type: "code", lang: "astro", label: "astro", code: `---
const sections = [
  {
    id: "navigation",
    title: "Navigation",
