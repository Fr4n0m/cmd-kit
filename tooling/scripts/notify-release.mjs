#!/usr/bin/env node
// Usage: node tooling/scripts/notify-release.mjs <packageName> <version> <changelogUrl> [locale]
// Requires PROJECT_NOTIFY_API_KEY env var.

const [packageName, version, changelogUrl, locale = "en"] = process.argv.slice(2);
...
const res = await fetch("https://www.codebyfran.es/api/projects/cmd-kit/notify", {
  method: "POST",
  headers: {
