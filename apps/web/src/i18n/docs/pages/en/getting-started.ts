...
export const gettingStartedENDoc: DocPageData = {
    ...
    sections: [
      ...
      { id: "npm-packages", label: "NPM package links", blocks: [{ type: "list", items: ['<a href="https://www.npmjs.com/package/@cmd-kit/react" target="_blank" rel="noopener noreferrer">@cmd-kit/react</a>', '<a href="https://www.npmjs.com/package/@cmd-kit/vue" target="_blank" rel="noopener noreferrer">@cmd-kit/vue</a>', '<a href="https://www.npmjs.com/package/@cmd-kit/preact" target="_blank" rel="noopener noreferrer">@cmd-kit/preact</a>', '<a href="https://www.npmjs.com/package/@cmd-kit/astro" target="_blank" rel="noopener noreferrer">@cmd-kit/astro</a>', '<a href="https://www.npmjs.com/package/@cmd-kit/core" target="_blank" rel="noopener noreferrer">@cmd-kit/core</a>'] }] },
