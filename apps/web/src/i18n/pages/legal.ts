...
export const legalPages: Record<Locale, Record<"privacy" | "terms", LegalPageCopy>> = {
  en: {
    ...
    terms: {
      ...
      heading: "Terms",
      paragraphs: [
        "Service owner: `Fr4n0m`. Public profile: `https://codebyfran.es`. Contact: `fran11799@outlook.com`.",
  ...
  es: {
    privacy: {
      ...
      heading: "Privacidad",
      paragraphs: [
        "Responsable: `Fr4n0m` (titular del proyecto y del sitio). Perfil público: `https://codebyfran.es`. Contacto: `fran11799@outlook.com`.",
    ...
    terms: {
      ...
      heading: "Términos",
      paragraphs: [
        "Titular del servicio: `Fr4n0m`. Perfil público: `https://codebyfran.es`. Contacto: `fran11799@outlook.com`.",
